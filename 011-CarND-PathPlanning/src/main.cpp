...
#define SPEED_INCREMENT_PER_PERIOD (0.224)
...
int main()
{
    ...
    h.onMessage(
        [&ref_speed, &map_waypoints_x, &map_waypoints_y, &map_waypoints_s, &map_waypoints_dx, &map_waypoints_dy, &lane, &num_units_in_current_lane](
                ...
                if (s != "")
                {
                    ...
                    if (event == "telemetry")
                    {
                        ...
                        if (too_close)
                        {
                            ...
                            {
                                if (candidateLane[i] && isSmoothShiftPossible(lane, i) && (num_units_in_current_lane > 10))
                                {
                                    lane = i;
